...
def analyze_server_software(db_file, limit=10):
    ...
    try:
        ...
        server_patterns = {
            ...
            'FTP Voyager': re.compile(r'FTP\s+Voyager\s+Server', re.IGNORECASE),
            'FTPGetter': re.compile(r'FTPGetter\s+Server', re.IGNORECASE),
            'FTP Now': re.compile(r'FTP\s+Now\s+Server', re.IGNORECASE),
            'FTP Commander': re.compile(r'FTP\s+Commander\s+Server', re.IGNORECASE),
            ...
            'FTPRush': re.compile(r'FTPRush\s+Server', re.IGNORECASE),
            'FTPCube': re.compile(r'FTPCube\s+Server', re.IGNORECASE),
            'FTPDrive': re.compile(r'FTPDrive\s+Server', re.IGNORECASE),
            'FTPInfo': re.compile(r'FTPInfo\s+Server', re.IGNORECASE),
            'FTPRocket': re.compile(r'FTPRocket\s+Server', re.IGNORECASE),
            'FTPShare': re.compile(r'FTPShare\s+Server', re.IGNORECASE),
            'FTPWare': re.compile(r'FTPWare\s+Server', re.IGNORECASE),
